                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mt-1">Minimum investment: ₹5,000</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="grid grid-cols-3 gap-3">
                                            {[5000, 10000, 25000, 50000, 100000, "custom"].map((val) => (
                                                ...
                                                >
                                                    <p className="text-sm font-black whitespace-nowrap">{val === "custom" ? "Custom" : `₹${(val / 1000).toFixed(0)}K`}</p>
                                                    {typeof val === 'number' && (
                                                        <p className={cn(
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {amount < 5000 && <p className="text-xs font-bold text-red-500 uppercase tracking-widest">Minimum ₹5,000 required</p>}
                                            {amount > 1000000 && <p className="text-xs font-bold text-amber-500 uppercase tracking-widest">Maximum ₹10L per transaction</p>}
